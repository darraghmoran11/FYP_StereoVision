...
print "camera matrix: ", cameraMatrix1
print "dist: ", distCoeffs1
#fs1 << "R1" << R1;
#fs1 << "R2" << R2;
#fs1 << "P1" << P1;
#fs1 << "P2" << P2;
...
while(True):
    ...
    imgU1 = cv2.remap(img1, map1x, map1y, cv2.INTER_LINEAR)
    #print "img1: ", img1.dtype
    #print "imgU1: ", imgU1.dtype
    ...
    gray_left = cv2.cvtColor(imgU1, cv2.COLOR_BGR2GRAY)
    gray_right = cv2.cvtColor(imgU2, cv2.COLOR_BGR2GRAY)
